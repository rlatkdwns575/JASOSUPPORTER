...
export 'package:chatgptmini/features/experience/experience_field_style.dart'
    show campusFieldDecoration;

/// 교내활동 소분류 입력 화면 공통 셸.
class CampusInputShell extends StatefulWidget {
  const CampusInputShell({
    super.key,
  ...
  @override
  State<CampusInputShell> createState() => _CampusInputShellState();
}

class _CampusInputShellState extends State<CampusInputShell> {
  bool _saving = false;
  ...
  Widget build(BuildContext context) {
    ...
    return ExperienceInputChrome(
      ...
      onBack: () => context.go(AppRoutes.experienceFormCategory('campus')),
      form: widget.form,
      onSubmit: _save,
      submitLabel:
