...
export 'package:chatgptmini/features/experience/experience_field_style.dart'
    show externalFieldDecoration;

/// 교외활동 소분류 입력 화면 공통 셸.
class ExternalInputShell extends StatefulWidget {
  const ExternalInputShell({
    super.key,
  ...
  @override
  State<ExternalInputShell> createState() => _ExternalInputShellState();
}

class _ExternalInputShellState extends State<ExternalInputShell> {
  bool _saving = false;
  ...
  Widget build(BuildContext context) {
    ...
    return ExperienceInputChrome(
      ...
      onBack: () => context.go(AppRoutes.experienceFormCategory('external')),
      form: widget.form,
      onSubmit: _save,
      submitLabel:
